...
function animationFactory(duration: string | number = 500, delay: string | number = 0, easing: string | {} = 'linear'): AnimationEntryMetadata {
...
export default {
    animations : animationFactory(500, 0, { 'fade': 'ease-in' })
}